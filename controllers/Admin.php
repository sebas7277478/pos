...
class Admin extends Controller
{
    ...
    public function index()
    {
        ...
        $total = 0;        
        $datos['productos'] = $this->model->totalInversion();
        ...
        $data['inversion'] = ($total != null) ? $total : 0 ;

        $sumCreditos['total'] = $this->model->totalCreditos();
        $data['creditos'] = ($sumCreditos['total'] != null) ? $sumCreditos['total'] :  0;
