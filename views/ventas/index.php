        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active p-3" id="nav-ventas" role="tabpanel" aria-labelledby="nav-ventas-tab" tabindex="0">
                ...
                <div class="input-group d-none mb-2" id="containerNombre">
                    <span class="input-group-text"><i class="fas fa-search"></i></span>
                    <input class="form-control" type="text" id="buscarProductoNombreVentas" placeholder="Buscar Producto" autocomplete="off">
                </div>
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input class="form-control" type="text" id="pagar_con" placeholder="0.00" autocomplete="off" step="0.01" min="0.01">
                        </div>
                        <label>Cambio</label>
                        <div class="input-group mb-2">
                            <span class="input-group-text"><i class="fas fa-dollar-sign"></i></span>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group mb-2">
                            <span class="input-group-text"><i class="fas fa-dollar-sign"></i></span>
                            <input class="form-control" type="text" id="descuento" placeholder="Descuento" autocomplete="off">
                        </div>
            ...
            <div class="tab-pane fade p-3" id="nav-historial" role="tabpanel" aria-labelledby="nav-historial-tab" tabindex="0">
                ...
                <?php if ($_SESSION['rol'] === 1): ?>
                    <div class="d-flex justify-content-between align-items-end mb-3 flex-wrap gap-3 mt-3">
                        <!-- Título -->
                        <div>
                            <h4 class="mb-0 fw-bold text-primary">
                                <i class="fas fa-chart-line me-2"></i>Balance Ventas
                            </h4>
                        </div>
