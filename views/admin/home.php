        ...
        <div class="card radius-10">
            <div class="card-body">
                ...
                <div class="d-flex align-items-center ms-auto font-13 gap-2 my-3">
                    ...
                    <span class="border px-1 rounded cursor-pointer"><i class="fas fa-dollar-sign" style="color: #85bb65"></i><?php echo ($data['inversion'] == 0) ? 0 : number_format($data['inversion']); ?></span>
                    <span class="border px-1 rounded cursor-pointer"><i class="fa-solid fa-credit-card" style="color: #f72226"></i> <?php echo ($data['creditos']['total'] == 0) ? 0 : number_format($data['creditos']['total']) ; ?></span>
                </div>
