                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" id="monto" type="number" step="0.01" min="0.01" name="monto" placeholder="Monto" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-md-8">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="input-group mb-2">
                    <span class="input-group-text"><i class="fas fa-dollar-sign"></i></span>
                    <input class="form-control" type="text" id="monto_inicial" placeholder="Monto Inicial" autocomplete="off">
                </div>
                <div class="d-grid">
