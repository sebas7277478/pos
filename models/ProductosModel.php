...
class ProductosModel extends Query{
    ...
    public function registrar($codigo, $nombre, $precio_compra, $precio_venta,$vencimiento,
    $id_medida, $id_categoria, $foto)
    {
        $sql = "INSERT INTO productos (codigo, descripcion, precio_compra, precio_venta, vencimiento, id_medida, id_categoria, foto) VALUES (?,?,?,?,?,?,?,?)";
        $array = array($codigo, $nombre, $precio_compra, $precio_venta, $vencimiento,
        $id_medida, $id_categoria, $foto);
    ...
    public function actualizar($codigo, $nombre, $precio_compra, $precio_venta, $vencimiento,
    $id_medida, $id_categoria, $foto, $id)
    {
        $sql = "UPDATE productos SET codigo=?, descripcion=?, precio_compra=?, precio_venta=?, vencimiento=?, id_medida=?, id_categoria=?, foto=? WHERE id=?";
        $array = array($codigo, $nombre, $precio_compra, $precio_venta, $vencimiento,
        $id_medida, $id_categoria, $foto, $id);
        return $this->save($sql, $array);
    }
